// Pixel animation for header background
(function() {
  // Create container for animation inside header
  let container = document.getElementById('header-pixel-container');
  if (!container) {
    const header = document.querySelector('header');
    container = document.createElement('div');
    container.id = 'header-pixel-container';
